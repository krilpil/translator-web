            ...
            <FadeIn>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-x-4">
                            <div className="flex gap-x-4">
                                <div>
                                    <div
                                        className="flex h-11 w-11 items-center justify-center rounded-full bg-white pb-1 text-xl font-normal text-black">ru
                                    </div>
                                </div>
                            </div>
                            <Link to="/Library">
                ...
                <div>
                    <div className="wrap flex flex-col sm:flex-row">
                        <p className="font-helvetica mb-2 text-sm leading-[14px] font-light whitespace-nowrap text-white sm:mr-[57px] sm:mb-0">/о
                            языке</p>
                        <p className="text-base leading-[20px] font-normal text-white sm:text-xl"
                           style={{ fontFamily: 'Teletactile, sans-serif' }}>
                            Язык, соединивший в себе все относительно популярные сленговые слова и фразочки! Язык,
                            соединивший в себе все относительно популярные Язык, соединивший
                    ...
                    <div className="wrap mt-4 flex flex-col sm:mt-8 sm:flex-row">
                        ...
                        <p className="text-xl text-[28px] leading-[20px] font-normal text-white sm:text-[35px]"
                           style={{ fontFamily: 'Teletactile, sans-serif' }}>
                            <label
                                className="font-teletactile text-[57px] leading-[40px] font-normal text-white sm:leading-[57px]">200+</label>
                    ...
                    <div className="wrap mt-5 flex flex-col sm:mt-8 sm:flex-row">
                        ...
                        <div className="flex flex-1 flex-col sm:flex-row sm:items-center sm:justify-between">
                            <div className="mr-3 mb-5 flex items-center sm:mb-0">
                                ...
                                <div
                                    className="ml-3 flex h-[34px] w-[34px] cursor-pointer items-center justify-center overflow-hidden rounded-full bg-white">
                            ...
                            <div className="relative h-12 w-full rounded-[68.75px] bg-white sm:w-80">
                                <div
                                    ...
                                    <div
                                        className="h-[30px] w-[30px] cursor-pointer overflow-hidden rounded-full bg-white">
                                        <img src="/images/jpgImg/link.png" alt="Link"
                                             className="h-full w-full object-cover" />
                                    </div>
                                </div>
                                <div
                                    className="absolute top-1/2 right-5 h-[30px] w-[30px] -translate-y-1/2 transform cursor-pointer overflow-hidden rounded-full bg-white">
                                    <img src="/images/jpgImg/repost.jpg" alt="Link"
                                         className="mt-[-1px] h-full w-full object-cover" />
                                </div>
                            </div>
                        </div>
                    </div>
